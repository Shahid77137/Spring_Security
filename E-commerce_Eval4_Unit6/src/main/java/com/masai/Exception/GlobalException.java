...
public class GlobalException {
	...
	public ResponseEntity<MyErrorDetails> exceptionHandler5(ProductException ce, WebRequest req) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
	...
	public ResponseEntity<MyErrorDetails> exceptionHandler5(OrderException ce, WebRequest req) {
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(ce.getMessage());
		err.setDescription(req.getDescription(false));
